...
import com.formas1.ruispantry.blocks.deep_fryer.slots.SlotDeepFryerFuel;
...
public class TileEntityDeepFryer extends TileEntityLockable implements ITickable, ISidedInventory
{
	...
	{
		return this.hasCustomName() ? this.furnaceCustomName : "container.deep_fryer";
	}
	...
	{
		fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityDeepFryer.class, new String[] {"items"}));
	}
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                DeepFryer.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = DeepFryerRecipes.instance().getCookingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = DeepFryerRecipes.instance().getCookingResult(itemstack);
    ...
    public static int getItemBurnTime(ItemStack stack)
    {
         ...
         else
         {
             ...
             ItemStack fluid = FluidUtil.getFilledBucket(new FluidStack(FluidInit.OIL_FLUID, burnTime));
             
             if (item == fluid.getItem())
             {
                 return 200;
             }
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) 
    {
    	...
    	{
    		ItemStack itemStack = this.furnaceItemStacks.get(1);
    		return isItemFuel(stack) || SlotDeepFryerFuel.isBucket(stack) && itemStack.getItem() != Items.BUCKET;
    	}
    }
    ...
    {
    	return "rpantry:deep_fryer";
    }
    
    @Override
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) 
    {
    	return new ContainerDeepFryer(playerInventory, this);
    }
