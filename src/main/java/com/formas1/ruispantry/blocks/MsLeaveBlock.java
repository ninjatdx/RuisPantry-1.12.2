...
public class MsLeaveBlock extends BlockLeaves implements IHasModel
{
	
    public MsLeaveBlock(String name)
    {
    ...
    {
        return Item.getItemFromBlock(ModBlocks.MILKSHAKE_SAPLING);
    }
