...
public class FormasLeaveBlock extends BlockLeaves implements IHasModel
{
	
    public FormasLeaveBlock(String name)
    {
    ...
    {
        return Item.getItemFromBlock(ModBlocks.FORMAS_SAPLING);
    }
