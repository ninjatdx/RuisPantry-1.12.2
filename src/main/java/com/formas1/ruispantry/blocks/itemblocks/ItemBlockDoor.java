package com.formas1.ruispantry.blocks.itemblocks;
			...
			EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		else
		{
			...
			if(player.canPlayerEdit(pos, facing, stack) && this.block.canPlaceBlockAt(worldIn, pos))
			{
				...
				worldIn.playSound(player, pos, sound.getPlaceSound(), SoundCategory.BLOCKS, (sound.getVolume() + 1.0F / 2.0F), sound.getPitch() * 0.0F);
