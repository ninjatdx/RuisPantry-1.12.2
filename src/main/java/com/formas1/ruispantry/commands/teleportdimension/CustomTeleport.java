package com.formas1.ruispantry.commands.teleportdimension;
...
public class CustomTeleport extends Teleporter{
	...
	{
		this.world.getBlockState(new BlockPos((int)this.x, (int)this.y, (int)this.x));
        ...
        for (int j1 = -2; j1 <= 2; ++j1)
        {
            for (int k1 = -2; k1 <= 2; ++k1)
            {
                for (int l1 = -1; l1 < 3; ++l1)
                {
                    ...
                    int k2 = k + k1 * 0 - j1 * 1;
                    boolean flag = l1 < 0;
                    this.world.setBlockState(new BlockPos(i2, j2, k2), flag ? ModBlocks.SPINEL_BLOCK_OFF.getDefaultState() : Blocks.AIR.getDefaultState());
                }
            }
        }
