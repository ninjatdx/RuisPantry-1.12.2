...
public class WorldGenTreesMilkshake extends WorldGenAbstractTree
{
	 private IBlockState blockStateWood = ModBlocks.MILKSHAKE_LOG.getDefaultState();
	 private IBlockState blockStateLeaves = ModBlocks.MILKSHAKE_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
	 private final int minTreeHeight = 5;
	 
	  public WorldGenTreesMilkshake(boolean parShouldNotify)
	    {
