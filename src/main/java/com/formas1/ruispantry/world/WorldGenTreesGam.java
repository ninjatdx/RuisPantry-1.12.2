...
public class WorldGenTreesGam extends WorldGenAbstractTree
{
	 private IBlockState blockStateWood = ModBlocks.GAM_LOG.getDefaultState();
	 private IBlockState blockStateLeaves = ModBlocks.GAM_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
	 private final int minTreeHeight = 5;
	 
	  public WorldGenTreesGam(boolean parShouldNotify)
	    {
