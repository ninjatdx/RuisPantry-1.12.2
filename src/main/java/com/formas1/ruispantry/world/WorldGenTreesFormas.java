...
public class WorldGenTreesFormas extends WorldGenAbstractTree
{
	 private IBlockState blockStateWood = ModBlocks.FORMAS_LOG.getDefaultState();
	 private IBlockState blockStateLeaves = ModBlocks.FORMAS_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
	 private final int minTreeHeight = 5;
	 
	  public WorldGenTreesFormas(boolean parShouldNotify)
	    {
